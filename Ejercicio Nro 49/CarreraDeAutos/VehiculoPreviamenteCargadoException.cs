...
{
    class VehiculoPreviamenteCargadoException : Exception
    {
        string nombreClase;
        string nombreMetodo;
        ...
        public VehiculoPreviamenteCargadoException(string mensaje, string nombreClase, string nombreMetodo) : base(mensaje)
        {
