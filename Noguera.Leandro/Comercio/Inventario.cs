...
namespace Comercio
{
    public static class Inventario
    {
        ...
        public static string UsuarioActivo
        {
            ...
            set
            {
                if (!Validar.ValidarString(value))
                {
                    usuarioActivo = value;
                }
            }
        ...
        /// </summary>
        /// <param name="auxDescripcion"></param>
        /// <param name="auxCantidad"></param>
        /// <returns>Si hay stock disponible devuelve true. Caso contrario, false</returns>
        public static bool ValidarCantidad(string auxDescripcion, int auxCantidad)
        {
            for (int i = 0; i < listaProductos.Count; i++)
            {
                if(listaProductos[i].Descripcion == auxDescripcion && listaProductos[i].Stock >= auxCantidad)
                {
                    return true;
                }
            }
        ...
        public static void HardcodeoEmpleados()
        {
            ...
            string[] usuario = new string[3] { "rodriguez1", "oggioni1", "davila1" };
